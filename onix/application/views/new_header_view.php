...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/styles/dataTables.bootstrap.css');?>"/>
	...
	<script type="text/javascript">
		...
		var website_url = base_url.replace("onix/", "");
	</script>
</head>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html">Dental Zone - Administrator</a>
			</div>
			<!-- /.navbar-header -->
		...
		<?php $this->load->view('new_sidebar_view'); ?>